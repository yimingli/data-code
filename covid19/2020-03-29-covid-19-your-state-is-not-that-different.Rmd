...
states_cumulative %>%
    ...
    labs(x = "Number of Confirmed Case (log10 scale)",
         ...
         title = "All US States' cases are growing exponentially, and no sign of slowing down",
...
See the [notebook](https://github.com/yimingli/data-code/blob/master/covid19/2020-03-29-covid-19-your-state-is-not-that-different.Rmd) for code and data.
